...
namespace TeslaCamViewer
{
    ...
    public class TeslaCamFile
    {
        ...
        private readonly string FileNameRegex = "([0-9]{4}-[0-9]{2}-[0-9]{2}_[0-9]{2}-[0-9]{2}(?:-[0-9]{2})?)-([a-z_]*).mp4"; public string FilePath { get; private set; }
        ...
        public TeslaCamFile(string FilePath)
        {
            ...
            this.Date = new TeslaCamDate(matches[0].Groups[1].Value);
            string cameraType = matches[0].Groups[2].Value;
            if (cameraType == "front")
            {
